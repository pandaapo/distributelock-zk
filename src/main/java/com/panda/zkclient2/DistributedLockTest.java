...
//        distributedLockImplTest();
    ...
    private static void simpleDistributedLockImplTest() {
        ...
        final MyZkClient zkClientOne = new MyZkClient("192.168.25.131:2181,192.168.25.133:2181,192.168.25.134:2181", 10000, 10000, new BytesPushThroughSerializer());
        final SimpleDistributedLockImpl sdliOne = new SimpleDistributedLockImpl(zkClientOne, "/locker");

        final MyZkClient zkClientTwo = new MyZkClient("192.168.25.131:2181,192.168.25.133:2181,192.168.25.134:2181", 10000, 10000, new BytesPushThroughSerializer());
